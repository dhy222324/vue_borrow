   ...
   <!-- 底部导航 -->
	 <nav class="mui-bar mui-bar-tab" v-if="sh">
			<router-link to="/home" class="mui-tab-item">
				<span class="mui-icon mui-icon-home" style="color:#C0B07E"></span>
				<span class="mui-tab-label" style="color:gray">{{index}}</span>
			</router-link>
			<router-link to="/order" class="mui-tab-item">
				<span class="mui-icon iconfont icon-dingdan" style="color:#C0B07E"></span>
				<span class="mui-tab-label" style="color:gray">{{order}}</span>
			</router-link>
			<router-link to="/our" class="mui-tab-item">
				<span class="mui-icon iconfont icon-daohanglan-05" style="color:#C0B07E"></span>
				<span class="mui-tab-label" style="color:gray">{{our}}</span>
			</router-link>
		</nav>
	<!-- /底部导航 -->
